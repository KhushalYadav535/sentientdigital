...
const GetStarted = () => (
  <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 custom-scrollbar text-white">
    ...
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-24 text-center">
      <AnimatedTextReveal>
        <h1 className="text-4xl md:text-6xl font-bold mb-6">Get <GradientText>Started</GradientText></h1>
        <p className="text-gray-300">Assessment → Strategy → Pilot → Deployment.</p>
      </AnimatedTextReveal>
    </section>
    <section className="section-padding">
      <div className="container-custom grid gap-8 md:grid-cols-4">
        {['Assessment','Strategy','Pilot','Deployment'].map((t)=>(
