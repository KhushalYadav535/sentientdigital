...
import { ArrowRight, BarChart3, TrendingUp, Brain, Target, CheckCircle, Star, BarChart3 as BarChartIcon, Rocket, Award, Clock, Shield, Users, Zap, Lightbulb } from 'lucide-react';
...
const AccelerateDecisions = () => {
  ...
  const solutions = [
    {
      ...
      technology: 'Real-time data processing + AI analytics',
      roi: 'Reduce decision-making time by 90%',
      features: [
    ...
    },
    {
      ...
      icon: Shield,
      outcome: '60% reduction in business risks',
      technology: 'AI risk modeling + predictive analytics',
      roi: 'Prevent millions in potential losses',
      features: [
    ...
    },
    {
      ...
      icon: TrendingUp,
      outcome: '85% demand prediction accuracy',
      technology: 'Machine learning + market data analysis',
      roi: 'Optimize inventory and pricing strategies',
      features: [
  ...
  const stats = [
    { icon: Clock, number: "10x", label: "Faster Decisions", color: "from-blue-500 to-cyan-500" },
    { icon: Shield, number: "60%", label: "Risk Reduction", color: "from-green-500 to-emerald-500" },
    { icon: TrendingUp, number: "85%", label: "Prediction Accuracy", color: "from-purple-500 to-pink-500" },
    { icon: Lightbulb, number: "90%", label: "Time Savings", color: "from-yellow-500 to-orange-500" }
  ];

  const processSteps = [
    { icon: Brain, title: 'Data Analysis', desc: 'Comprehensive analysis of current decision-making processes and data sources' },
    { icon: Target, title: 'Strategy Design', desc: 'Custom AI-powered decision acceleration strategy development' },
    { icon: Rocket, title: 'Implementation', desc: 'Rapid deployment with real-time monitoring capabilities' },
    { icon: Award, title: 'Optimization', desc: 'Continuous improvement to maximize decision-making efficiency' }
  ];
        ...
        <div className="relative z-10 container-custom text-center text-white">
          <AnimatedTextReveal className="mb-8">
            ...
            <motion.h1 className="text-4xl md:text-6xl font-bold mb-6">
              Make Data-Driven Decisions 10x Faster with <GradientText>AI Insights</GradientText>
            </motion.h1>
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Transform your decision-making process with AI-powered analytics that deliver real-time insights and predictive intelligence. Make confident, data-driven decisions in minutes, not months.
            </p>
          </AnimatedTextReveal>
          <div className="mt-8 flex justify-center">
            <GlowButton icon={<ArrowRight className="w-5 h-5" />}>Get AI-Powered Insights</GlowButton>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <AnimatedTextReveal className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Decision Intelligence <GradientText className="text-4xl md:text-5xl">Solutions</GradientText>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Choose the solution that best fits your decision-making needs and start making faster, smarter decisions within 90 days
            </p>
          </AnimatedTextReveal>
      ...
      <section className="section-padding bg-gradient-to-r from-black/40 to-transparent">
        ...
        <div className="container-custom">
          <AnimatedTextReveal className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              A proven methodology to deliver faster, smarter decision-making
            </p>
          </AnimatedTextReveal>
      ...
      <section className="section-padding bg-gradient-to-r from-blue-600/20 to-purple-600/20">
        ...
        <div className="container-custom text-center">
          <AnimatedTextReveal className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Ready to Accelerate Your <GradientText className="text-4xl md:text-5xl">Decisions</GradientText>?
            </h2>
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Let's discuss how our AI-powered analytics can transform your decision-making process and give you a competitive advantage.
            </p>
...
export default AccelerateDecisions;
